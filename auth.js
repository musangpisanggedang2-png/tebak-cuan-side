...
// ---------------------------------------------------------------------
// Verifikasi bahwa initData beneran dikirim oleh Telegram, bukan dipalsu.
// ---------------------------------------------------------------------
function verifyTelegramInitData(initData) {
  ...
  if (computedHash !== hash) {
    return null; // data gak valid / dipalsukan
  }
...
// ---------------------------------------------------------------------
// Netlify Functions pakai format (event, context) => response object,
// beda dari Vercel yang pakai (req, res)
// ---------------------------------------------------------------------
